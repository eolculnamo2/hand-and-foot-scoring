...
import scoringCss from "~/styles/scoring.css";
    ...
    <body>
        ...
        <div className="nav-wrapper row">
          ...
          <div className="col s3 l4">
            <ul>
              ...
              <li>
                <a
                  className="button waves-effect waves-light red btn modal-trigger white-text"
                  href="#modal"
                >
                  Overview
                </a>
            ...
            <div className="card">
              <div className="card-content">
                ...
                <div className="card-action">
                  <div className="row">
                    <div className="heading col s6 m6 l6">CARDS AND MELDS</div>
                    <div className="heading col s2 m2 l2">Enter Number</div>
                    <div className="heading col s2 m2 l2">Points Earned</div>
                  </div>
                  <div className="row">
                    <div className="labels col s6 m6 l6">Go Out Bonus</div>

                    <div className="points col s2 m2 l2">
                      {" "}
                      <input id="" type="radio" className="validate" />
                    </div>
                    <div className="points col s2 m2 l2">
                      <input
                        placeholder="100"
                  ...
                  <div className="row">
                    <div className="labels col s6 m6 l6">Red 3s</div>

                    <div className="points col s2 m2 l2">
                      {" "}
                      <input id="red-3" type="number" className="validate" />
                    </div>
                    <div className="points col s2 m2 l2">
                      {" "}
                      <input
                  ...
                  <div className="row">
                    <div className="labels col s6 m6 l6">Wild Melds</div>
                  ...
                  <div className="row">
                    <div className="labels col s6 m6 l6">Clean Melds</div>
                  ...
                  <div className="row">
                    <div className="labels col s6 m6 l6">Dirty Melds</div>
                  ...
                  <div className="row">
                    <div className="labels col s6 m6 l6">Jokers</div>

                    <div className="points col s2 m2 l2">
                      {" "}
                      <input id="jokers" type="number" className="validate" />
                    </div>
                    <div className="points col s2 m2 l2">
                      {" "}
                      <input
                  ...
                  <div className="row">
                    <div className="labels col s6 m6 l6">Twos and Aces</div>
                  ...
                  <div className="row">
                    <div className="labels col s6 m6 l6">8 - King</div>

                    <div className="points col s2 m2 l2">
                      {" "}
                      <input id="8-king" type="number" className="validate" />
                    </div>
                    <div className="points col s2 m2 l2">
                      {" "}
                      <input
                  ...
                  <div className="row">
                    <div className="labels col s6 m6 l6">Black 3s, 4-7</div>
                    <div className="points col s2 m2 l2">
                      {" "}
                      <input id="4-7" type="number" className="validate" />
                    </div>
                    <div className="points col s2 m2 l2">
                      {" "}
                      <input
                  ...
                  <div className="row">
                    <div className="labels col s8 m8 l8">Subtract</div>
                    <div className="value col s2 m2 l2"></div>
                    <div className="points col s2 m2 l2"></div>
                  </div>
                </div>
                <button
                  className="button btn-large waves-effect waves-light red"
                  type="submit"
                  name="action"
                >
                  Submit
      ...
      <div id="modal" className="modal">
              ...
              <div className="collapsible-body">
                <span>
                  <p>
                    ...
                    If 4 players, use 5 decks. <br />• Jokers are included.{" "}
        ...
        <div className="modal-footer">
          <a
            href="#!"
            className="button modal-close waves-effect waves red btn-raised white-text"
          >
            Close
          </a>
        </div>
